...
export const useShuangpinStore = defineStore('shuangpin', {
  ...
  getters: {
    ...
    currentScheme() {
      return (
        SHUANGPIN_SCHEMES[this.currentSchemeKey] ||
        this.customSchemes[this.currentSchemeKey] ||
        SHUANGPIN_SCHEMES.xiaohe
      )
    },
  ...
  actions: {
    ...
    updateKeyMastery(key, accuracy, speed) {
      ...
      mastery.accuracy =
        (mastery.accuracy * (mastery.practiceCount - 1) + accuracy) / mastery.practiceCount
