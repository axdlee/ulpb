        ...
        <div class="header-content">
          ...
          <div class="header-controls">
            ...
            <div class="analysis-actions">
              <Button variant="outline" @click="refreshAnalysis" :loading="isRefreshing">
                🔄 刷新
              </Button>
              <Button variant="outline" @click="exportReport"> 📊 导出报告 </Button>
              <Button variant="ghost" @click="toggleSettings"> ⚙️ 设置 </Button>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="index-components">
                      ...
                      <div class="component-item">
                        ...
                        <span class="component-value"
                          >{{ performanceComponents.improvement }}%</span
                        >
                      </div>
                    </div>
                  </div>
          ...
          <div class="charts-section">
            <div class="charts-grid">
              ...
              <Card class="chart-card">
                ...
                <div class="chart-container">
                  <SankeyChart :data="errorPatternData" :options="sankeyOptions" :height="300" />
                </div>
              </Card>
              ...
              <Card class="chart-card">
                ...
                <div class="chart-container">
                  <RadarChart :data="skillRadarData" :options="radarOptions" :height="300" />
                </div>
              </Card>
              ...
              <template #header>
                <div class="drill-down-header">
                  ...
                  <div class="drill-down-controls">
                    ...
                    <Button variant="outline" size="sm" @click="exportDrillDownData">
                      📤 导出数据
                    </Button>
                  </div>
                </div>
                ...
                <div class="drill-down-grid">
                  ...
                  <div class="dimension-overview">
                    ...
                    <div class="overview-stats">
                      <div v-for="stat in drillDownStats" :key="stat.key" class="overview-stat">
                      ...
                      <div class="goal-details">
                        ...
                        <div class="goal-deadline" v-if="goal.deadline">
                          ...
                          <span class="deadline-text"
                            >目标时间: {{ formatDate(goal.deadline) }}</span
                          >
                        </div>
                      </div>
                      <div class="goal-actions">
                        <Button variant="ghost" size="sm" @click="adjustGoal(goal)"> 调整 </Button>
                      </div>
                    </div>
                  </div>
                  <div class="goals-actions">
                    <Button variant="solid" @click="createNewGoal"> ➕ 设定新目标 </Button>
                  </div>
                </div>
              </Card>
            </div>
            ...
            <Card class="optimization-card">
              ...
              <div class="optimization-content">
                ...
                <div class="optimization-panel">
                  ...
                  <!-- 内容优化 -->
                  <div
                    v-else-if="selectedOptimizationTab === 'content'"
                  ...
                  <!-- 环境优化 -->
                  <div
                    v-else-if="selectedOptimizationTab === 'environment'"
...
<script setup>
  ...
  const performanceTrendData = computed(() => {
    return practiceStore.getPerformanceTrendData(
      selectedTimeRange.value,
      selectedPerformanceMetric.value
    )
  })
  ...
  const drillDownStats = computed(() => {
    return practiceStore.getDrillDownStats(
      selectedDrillDownDimension.value,
      selectedTimeRange.value
    )
  })

  const drillDownTableData = computed(() => {
    return practiceStore.getDrillDownTableData(
      selectedDrillDownDimension.value,
      selectedTimeRange.value
    )
  })
