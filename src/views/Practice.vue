...
<template>
  <div class="practice">
            ...
            <div class="stat-item">
              ...
              <div class="stat-content">
                <div class="stat-value">
                  {{ formatTime(practiceStore.currentStats.duration || 0) }}
                </div>
        ...
        <div class="practice-content">
              ...
              >
                ...
                <div class="mode-content">
                  ...
                  <div class="mode-features">
                    <span v-for="feature in mode.features" :key="feature" class="mode-feature">
                      {{ feature }}
                    </span>
                  </div>
                </div>
          ...
          <div class="practice-active" v-else>
            ...
            <div class="typing-area">
              ...
              <!-- 输入提示 -->
              <InputFeedback :feedback="practiceStore.inputFeedback" :show-hints="showHints" />
            </div>

            <!-- 练习控制 -->
            <div class="practice-controls">
              <div class="control-left">
                <Button variant="ghost" @click="toggleHints" :class="{ active: showHints }">
                  💡 提示
                </Button>
                <Button variant="ghost" @click="pausePractice" v-if="!practiceStore.isPaused">
                  ⏸️ 暂停
                </Button>
                <Button variant="ghost" @click="resumePractice" v-else> ▶️ 继续 </Button>
              </div>

              <div class="control-right">
                <Button variant="outline" @click="restartPractice"> 🔄 重新开始 </Button>
      ...
      <div class="practice-sidebar" v-if="showSidebar">
        <div class="sidebar-content">
          <div class="sidebar-header">
            ...
            <Button variant="ghost" size="sm" @click="closeSidebar"> ✕ </Button>
          </div>
    ...
    <!-- 设置面板 -->
    <PracticeSettings v-if="showSettings" @close="closeSettings" />
  </div>
</template>
