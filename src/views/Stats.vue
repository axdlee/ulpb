        ...
        <div class="header-content">
          ...
          <div class="header-controls">
            ...
            <div class="action-buttons">
              <Button variant="outline" @click="exportStats"> 📤 导出数据 </Button>
              <Button variant="ghost" @click="refreshStats" :loading="isRefreshing">
                🔄 刷新
              </Button>
            </div>
          </div>
          ...
          <div class="charts-section">
            <div class="charts-grid">
              ...
              <Card class="chart-card">
                ...
                <div class="chart-container">
                  <BarChart :data="keyErrorData" :options="barChartOptions" :height="300" />
                </div>
              </Card>
                  ...
                  >
                    ...
                    <div class="insight-content">
                      ...
                      <div class="insight-action" v-if="insight.action">
                        <Button variant="outline" size="sm" @click="handleInsightAction(insight)">
              ...
              <template #header>
                <div class="comparison-header">
                  ...
                  <div class="comparison-controls">
                    ...
                    <Button variant="ghost" size="sm" @click="closeComparison"> ✕ </Button>
                  </div>
                </div>
              </template>
...
<script setup>
  ...
  const totalRecords = computed(() => {
    return practiceStore.getTotalRecords(
