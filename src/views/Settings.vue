    ...
    <section class="page-header">
      <div class="container">
        <div class="header-content">
          ...
          <p class="page-subtitle">个性化您的学习体验，调整应用配置</p>
        </div>
      </div>
    </section>
        ...
        <div class="settings-grid">
          ...
          <div class="settings-group">
            ...
            <div class="setting-item">
              ...
              <div class="setting-control">
                <select
                  v-model="shuangpinStore.currentSchemeKey"
                  @change="handleSchemeChange"
                  class="scheme-selector"
                >
                  <option
                    v-for="scheme in shuangpinStore.availableSchemes"
                    :key="scheme.key"
                    :value="scheme.key"
                  >
                    {{ scheme.name }}
                ...
                <div class="scheme-details">
                  ...
                  <div class="scheme-stats">
                    ...
                    <span class="stat-item"
                      >热度: {{ shuangpinStore.currentScheme.popularity }}%</span
                    >
                  </div>
                </div>
              </div>
          ...
          <div class="settings-group">
            ...
            <div class="setting-item">
              ...
              <div class="setting-control">
                <select
                  v-model="appStore.state.currentTheme"
          ...
          <div class="settings-actions">
            <button @click="resetSettings" class="btn btn-outline">🔄 重置设置</button>
            <button @click="exportSettings" class="btn btn-primary">📤 导出设置</button>
            <button @click="importSettings" class="btn btn-secondary">📥 导入设置</button>
          </div>
        </div>
      </div>
    </section>
