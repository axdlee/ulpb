          ...
          <div class="learning-active" v-else>
              ...
              <div class="step-content">
                <div class="step-header">
                  ...
                  <div class="step-controls">
                    ...
                    <Button variant="ghost" size="sm" @click="toggleSettings"> ⚙️ 设置 </Button>
                  </div>
                </div>
            ...
            <div class="learning-controls">
              <div class="control-left">
                <Button variant="outline" @click="previousLesson" :disabled="currentLessonId <= 1">
              ...
              <div class="control-center">
                <Button variant="ghost" @click="restartLesson"> 🔄 重新学习 </Button>
                <Button variant="solid" @click="startPractice" v-if="canStartPractice">
                  🚀 开始练习
                </Button>
              </div>

              <div class="control-right">
                <Button variant="outline" @click="nextLesson" :disabled="!canGoToNext">
                  下一课
                  <span class="button-icon">➡️</span>
                </Button>
              </div>
